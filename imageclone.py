...
def main():
	if not appex.is_running_extension():
		...
		#print(photos.get_albums())
		albums = photos.get_albums()
		albums = list(sorted(list([a for a in albums if len(a.assets) > 0 and search in a.title]), key=lambda a: a.end_date or '1970-01-01', reverse=True))
